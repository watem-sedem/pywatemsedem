...
class AbstractVector:
    ...
    def __init__(
        ...
        req_geometry_type: str, default None
            ...
            :func:`pyws.geo.vectors.AbstractVector.check_type`
        ...
        if req_geometry is not None:
            if req_geometry not in implemented_types:
                msg = (
                    ...
                    f"pyws. Please select '{' or '.join(implemented_types)}'"
                )
                raise TypeError(msg)
    ...
    def write(self, outfile_path):
        ...
        if outfile_path.suffix == ".shp":
            ...
            msg = f"Extension of  {outfile_path} not support in pyws"
            raise TypeError(msg)
        return True
...
class VectorMemory(AbstractVector):
    ...
    ----------
    geodata: geopandas.GeoDataFrame
        See :class:`pyws.geo.vectors.AbstractVector`
    geometry_type: str
        See :class:`pyws.geo.vectors.AbstractVector`
    req_geometry_type: str, default None
        See :class:`pyws.geo.vectors.AbstractVector`
