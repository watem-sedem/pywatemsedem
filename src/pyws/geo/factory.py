...
from .valid import PywsInputError, valid_exists
...
class Factory:
    ...
    def __init__(self, resolution, epsg_code, nodata, resmap, bounds=None):
        ...
        epsg_code: int
            See :class:`pyws.geo.rasterproperties.RasterProperties`
        nodata: float
            See :class:`pyws.geo.rasterproperties.RasterProperties`
        ...
        See :func:`pyws.geo.factory.create_mask`-function. This can be toggled of by
        setting :const:`pyws.geo.factory.Factory.create_rasterproperties` to False
        """
    ...
    @property
    def rp(self):
        "RasterProperties. See :class:`pyws.geo.rasterproperties.RasterProperties`"
        return self._rp
    ...
    @property
    def vct_mask(self):
        "AbstractRaster mask, See :class:pyws.geo.rasters.AbstractRaster"
    ...
    def create_mask(self, mask):
        ...
        Notes
        -----
        If :const:`pyws.geo.factory.Factory.create_rasterproperties` is set to False,
    ...
    def raster_factory(
        ...
        allow_nodata_array: default False
            ...
            see :func:`pyws.geo.rasters.AbstractRaster.mask`.

        Returns
        -------
        raster: pyws.geo.rasters.AbstractRaster
            See :class:`pyws.geo.rasters.AbstractRaster`
    ...
    def vector_factory(self, vector_input, geometry_type, allow_empty=False):
        ...
        allow_empty: bool, default False
            Allow vector to be empty, see :class:`pyws.geo.vectors.AbstractVector`

        Returns
        -------
        vector: pyws.geo.rasters.AbstractRaster
            See :class:`pyws.geo.rasters.AbstractRaster`
        """
