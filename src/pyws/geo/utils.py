...
def read_rasterio_profile(rst_in):
    ...
    -------
    profile: dict
        See :func:`pyws.geo.rasterproperties.RasterProperties.rasterio_profile`
    """
    with rasterio.open(rst_in) as src:
        profile = src.profile
...
def compute_statistics_rasters_per_polygon_vector(
    ...
    dict_operators: dict
        ...
        inputs in :func:`pyws.geo.utils.grid_statistics`. See example for use.
...
def merge_rasters(lst_rst, rst_out, lst_rst_masks=None):
    ...
    lst_rst_masks: list
        ...
        :func:`pyws.geo.utils.mask_raster`.
    """
...
def define_extent_from_vct(
    ...
    Returns
    -------
    rp: RasterProperties see :class:`pyws.geo.rasterproperties.RasterProperties`
