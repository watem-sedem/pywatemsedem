...
from pyws.pyws.tools import check_courant_criterium, get_item_from_ini
...
class UserChoices:
    ...
    def set_model_equation(self, type_model, model_equation, lst_possible_equations):
        ...
        Note
        ----
        See example use in :func:`pyws.pyws.CNWS.UserChoices.set_LS_equation`.
        """
    ...
    def set_userchoices_curvenumber(
        ...
        txt_rainfall_filename: str
            See :func:`pyws.pyws.CNWS.UserChoicesCurveNumber.check`
        rainfall_depth_antecedent: int
            Antecedent rainfall depth (mm).
        begin_date: pandas.DateTime
            See :func:`pyws.pyws.userchoices.UserChoicesCurveNumber.check`
