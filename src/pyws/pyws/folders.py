...
@dataclass
class PywsScenarioFolders:
    """Class for keeping track of Scenario folder names

    Parameters
    ----------
    cfolder: PywsCatchmentFolder
        See :class:`pyws.pyws.folders.PywsCatchmentFolder`
    scenario_label: str
...
def check_and_create_home_folder(home_folder, **options):
    ...
    home_folder: pathlib.Path
        Folder path of home.
    options:
        See :func:`pyws.pyws.folders.check_and_create_pyws_folder`
    """
...
def check_and_create_rst_folder(catchment_folder, resolution, **options):
    ...
    catchment_folder: pathlib.Path
        See :func:`pyws.pyws.folders.check_and_create_catchment_folder`
    resolution: int
        Spatial resolution
    options:
        See :func:`pyws.pyws.folders.check_and_create_pyws_folder`
...
def check_and_create_vctyears_folder(vct_folder, year, **options):
    ...
    vct_folder: pathlib.Path
        See :func:`pyws.pyws.folders.check_and_create_vct_folder`
    options:
        See :func:`pyws.pyws.folders.check_and_create_pyws_folder`
    """
    check_and_create_pyws_folder(
