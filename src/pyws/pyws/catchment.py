...
from pyws.io.modeloutput import check_segment_edges
from pyws.pyws.tools import (
...
from .folders import PywsCatchmentFolder
...
class Catchment(Factory):
    ...
    pyws factory class, see :class:`pyws.geo.factory.Factory`.
    """
    ...
    def __init__(
        ...
        if results_folder is None:
            ...
            warnings.warn(msg)
        self.folder = PywsCatchmentFolder(Path(results_folder) / name, resolution)
    ...
    def pfactor(self):
        ...
        RUSLE equation which takes into account erosion control. In pyws, this
    ...
    def adjacent_edges(self):
        ...
        (column 1) flows into segment to (column 2). See :ref:`here <cnws:adjsegments>`
    ...
    def up_edges(self):
        ...
        This property is generated by assigning a river line vector to the catchment
        class. See :ref:`here <cnws:upstrsegments>`
    ...
    def routing(self):
        ...
        See :ref:`here <cnws:riverroutingmap>`

        Returns
        -------
        pyws.geo.rasters.AbstractRaster or None
    ...
    def segments(self):
        ...
        See :ref:`here <cnws:riversegmentfile>`
    ...
    def topologize_river(
        ...
        adjacent_edges: pandas.DataFrame
           See :func:`pyws.pyws.catchment.Catchment.adjacent_edges` and
           :ref:`here <cnws:adjsegments>`.
        up_edges: pandas.DataFrame
            See :func:`pyws.pyws.catchment.Catchment.up_edges` and
            :ref:`here <cnws:upstrsegments>`.
        """
    ...
    def vct_water(self):
        ...
        Returns
        -------
        pyws.geo.vectors.AbstractVector
    ...
    def create_folder_structure(self):
        ...
        self.folder = PywsCatchmentFolder(Path(self.name), self.rp.resolution)
        self.folder.create_all()
