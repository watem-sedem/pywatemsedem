...
from pyws.geo.utils import nearly_identical, saga_intersection
from pyws.io.ini import IniFile
from pyws.pyws.cfactor import create_cfactor_cnws
from pyws.pyws.cn import process_cn_raster
from pyws.pyws.ktc import create_ktc_cnws
from pyws.pyws.parcelslanduse import ParcelsLanduse, get_source_landuse
...
from .folders import PywsScenarioFolders
...
class Scenario:
    ...
    :class:`pyws.pyws.userchoices.UserChoices`.
    ...
    def __init__(self, catchm, year, scenario_nr, userchoices):
        ...
        Parameters
        ----------
        catchm: pyws.core.catchment.Catchment
            Instance of :class:`pyws catchment <pyws.pyws.catchment.Catchment>`
            containing the catchment characteristics.
        year: int
            Simulation year
        scenario_nr: int
            Identifier number of the scenario.
        userchoices : pyws.core.userchoices.UserChoices
            Containing the pyws model settings.
        """
    ...
    def create_folder_structure(self):
        ...
        self.sfolder = PywsScenarioFolders(
    ...
    def temporal_resolution(self):
        ...
        :py:class:`CNWS.UserChoices <pyws.pyws.CNWS.UserChoices>` 'begin_jaar',
    ...
    def parcels(self):
        ...
        Returns
        -------
        pyws.geo.rasters.AbstractRaster
    ...
    def parcels_ids(self):
        ...
        Returns
        -------
        pyws.geo.rasters.AbstractRaster, else None
    ...
    def vct_grass_strips(self, vector_input):
        ...
        :func:`pyws.pyws.cfactor.create_cfactor_cnws` and
        :func:`pyws.pyws.ktc.create_ktc_cnws`
        ...
        vector_input: Pathlib.Path, str or geopandas.GeoDataFrame
            ...
            - *scale_ktc* (int): either 0 (scale or 1), if not kTC is not scaled, then
              the ktc_low (see :class:`pyws.pyws.userchoices.UserChoices`) is used,
              see :func:`pyws.pyws.ktc.scale_ktc_gdf_grass_strips`
    ...
    def grass_strips(self, raster_input):
        ...
        raster_input: Pathlib.Path, str or numpy.ndarray
            See :func:`pyws.pyws.catchment.raster_factory`.
        """
    ...
    def vct_bufferoutlets(self, vector_input):
        ...
        ----------
        vector_input: Pathlib.Path, str or geopandas.GeoDataFrame
            See :func:`pyws.pyws.catchment.vector_factory`.
        """
    ...
    def conductive_dams(self):
        ...
        Returns
        -------
        pyws.geo.raster.AbstractRaster
        """
    ...
    def vct_endpoints(self, vector_input):
        ...
        Notes
        -----
        1. In the WaTEM/SEDEM pyws engine, endpoints are named "sewers", see also
           :ref:`here <cnws:sewermapfile>`. Note that in pyws, type of endpoints can
    ...
    def create_perceelskaart_cnws(
        ...
        rp: pyws.geo.rasterproperties.RasterProperties
            Raster properties, see :class:`pyws.geo.rasterproperties.RasterProperties`
    ...
    def prepare_cnws_model_input(self, maximize_grass_strips=False):
        ...
        ----------
        maximize_grass_strips: bool, default False
            See :func:`pyws.pyws.scenario.create_perceelskaart_cnws`
        """
