...
from pyws.pyws.grasstrips import scale_ktc_with_grass_strip_width, scale_ktc_zhang
...
def scale_ktc_gdf_grass_strips(gdf_grass_strips, ktc_low, ktc_high):
    ...
    ktc_low: float
    ktc_high: float
        See :func:`pyws.pyws.grasstrips.scale_ktc_linear` and
        :func:`pyws.pyws.grasstrips.scale_ktc_zhang`.
