...
from pyws.geo.utils import write_arr_as_rst
...
class ParcelsLanduse:
    ...
    This parcels land-use raster is used as raster input for WaTEM/SEDEM pyws.
...
def create_parcels_landuse_degerick2015(
    ...
    grass strips, landuse from parcels data source, parcelsand finally pyws landuse.
    ...
    (see also :func:`pyws.pyws.scenario.map_input_array_on_array`). The pyws landuse
    raster is used to fill gaps.

    Parameters
    ----------
    landuse_core: numpy.ndarray
        See :class:`pyws.pyws.scenario.ParcelsLanduse`
    river: numpy.ndarray
        See :class:`pyws.pyws.scenario.ParcelsLanduse`
    water: numpy.ndarray
        See :class:`pyws.pyws.scenario.ParcelsLanduse`
