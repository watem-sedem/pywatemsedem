...
from pyws.geo.utils import grid_difference
from pyws.pyws.tools import zip_folder

from ..io.modeloutput import load_total_sediment_file
...
class DeltaScenario:
    ...
    Parameters
    ----------
    pp1: pyws.pyws.postproces.PostProcess
        First PostProcess instance of scenario used for the comparison.
    pp2: pyws.pyws.postproces.PostProcess
    ...
    def __init__(self, pp1, pp2, resmap=None):
        ...
        Parameters
        ----------
        pp1: pyws.core.postprocess.PostProcess
            See class:`pyws.pyws.postprocess.PostProcess`
        pp2: pyws.core.postprocess.PostProcess
            See class:`pyws.pyws.postprocess.PostProcess`
    ...
    def check_input(self, pp):
        ...
        Parameters
        ----------
        pp : pyws.pyws.postproces.PostProcess
        ...
        if not isinstance(pp, PostProcess):
            msg = (
                ...
                f"see ~:class:pyws.pyws.postprocess.PostProcess"
            )
            raise IOError(msg)
        else:
            return True
