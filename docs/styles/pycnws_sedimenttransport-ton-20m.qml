...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.16.16-Hannover" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" opacity="1" classificationMin="0" type="singlebandpseudocolor" classificationMax="80" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" colorRampType="INTERPOLATED" classificationMode="1" clip="0" maximumValue="80" labelPrecision="6">
          ...
          <item label="10" alpha="255" value="10" color="#fecc5c"/>
          <item label="20" alpha="255" value="20" color="#ff8c00"/>
          <item label="40" alpha="255" value="40" color="#d7191c"/>
          <item label="80" alpha="255" value="80" color="#bd0026"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
