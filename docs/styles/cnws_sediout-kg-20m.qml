...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.16.16-Hannover" minScale="1e+08" styleCategories="AllStyleCategories">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" opacity="1" classificationMin="0" type="singlebandpseudocolor" classificationMax="80000" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader minimumValue="0" colorRampType="INTERPOLATED" classificationMode="1" clip="0" maximumValue="80000" labelPrecision="6">
          ...
          <item label="10000" alpha="255" value="10000" color="#fecc5c"/>
          <item label="20000" alpha="255" value="20000" color="#ff8c00"/>
          <item label="40000" alpha="255" value="40000" color="#d7191c"/>
          <item label="80000" alpha="255" value="80000" color="#bd0026"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
