...
<qgis simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" version="3.2.0-Bonn" maxScale="0">
  ...
  <attributeactions>
    <defaultAction value="{66282e6f-685f-48a3-83da-3957cf0831ed}" key="Canvas"/>
    <actionsetting shortTitle="" isEnabledOnlyWhenEditable="0" id="{45811083-269e-4185-b588-0234016f1766}" notificationMessage="" capture="0" type="0" action="" icon="" name="">
