...
<qgis simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" version="3.2.0-Bonn" maxScale="0">
  ...
  <attributeactions>
    <defaultAction value="{c8cb3d35-cb92-41ca-b5ee-baab0e81c6b8}" key="Canvas"/>
    <actionsetting shortTitle="" isEnabledOnlyWhenEditable="0" id="{27ca28a7-ed53-4ff7-b169-a39bd2f5c660}" notificationMessage="" capture="0" type="0" action="" icon="" name="">
