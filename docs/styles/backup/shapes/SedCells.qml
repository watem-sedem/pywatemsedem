...
<qgis simplifyDrawingTol="1" labelsEnabled="0" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" maxScale="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" readOnly="0" version="3.4.4-Madeira" minScale="1e+08">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{f55d09b7-58a9-4ee0-8db9-aaf23ef2bf99}">
      <rule label="zeer hoog" key="{fbf6c8c5-be0a-4732-a96f-225951485f95}" filter=" &quot;SedCells&quot; >2" symbol="0"/>
      <rule label="hoog" key="{55cd59d7-51c5-4eb9-abbb-533dd25744ea}" filter=" &quot;SedCells&quot; &lt;=2 and   &quot;SedCells&quot; >1.5" symbol="1"/>
      <rule label="gemiddeld" key="{80e9c5bf-b9c5-4fe6-b6e0-7df4f74a2fb3}" filter=" &quot;SedCells&quot; &lt;=1.5 and  &quot;SedCells&quot; >1" symbol="2"/>
      <rule label="laag" key="{cd549ae4-91b8-4656-b533-eaa5b3627712}" filter=" &quot;SedCells&quot; &lt;=1 and   &quot;SedCells&quot; >0.5" symbol="3"/>
      <rule label="zeer laag" key="{1e1f8c40-6f7e-4e1e-b4a3-7c6e2fdc1a17}" filter=" &quot;SedCells&quot; &lt;=0.5" symbol="4"/>
    </rules>
    <symbols>
      <symbol name="0" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="84,39,143,255"/>
      ...
      <symbol name="2" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="158,154,200,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol name="3" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="203,201,226,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol name="4" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="242,240,247,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;SedCells&quot;" sortOrder="1">
    <columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="RAPBEKNR"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="A0_NAAM"/>
    ...
    <field labelOnTop="0" name="RAPBEKNR"/>
