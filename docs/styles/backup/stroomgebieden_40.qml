...
<qgis simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" version="3.2.0-Bonn" maxScale="0">
  ...
  <attributeactions>
    <defaultAction value="{4f65cbe1-d559-4425-81d4-79396ecb57f6}" key="Canvas"/>
    <actionsetting shortTitle="" isEnabledOnlyWhenEditable="0" id="{8e8fa3f4-9406-475d-b76a-34cb74de4d8d}" notificationMessage="" capture="0" type="0" action="" icon="" name="">
