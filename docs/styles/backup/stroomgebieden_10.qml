...
<qgis simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" readOnly="0" version="3.2.0-Bonn" maxScale="0">
  ...
  <attributeactions>
    <defaultAction value="{5e9ea413-c3ab-4799-b388-89ddd4be397e}" key="Canvas"/>
    <actionsetting shortTitle="" isEnabledOnlyWhenEditable="0" id="{c929adeb-1694-480a-851d-c29f8c714090}" notificationMessage="" capture="0" type="0" action="" icon="" name="">
