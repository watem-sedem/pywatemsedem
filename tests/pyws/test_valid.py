...
from pyws.pyws.valid import valid_req_property


class ExampleClass:
    """Example class for testing decorator pyws.pyws.valid.valid_req_property"""
...
class TestValidSourceProperty:
    ...
    pyws.pyws.valid.valid_req_property
